...
# Répertoire racine du projet (dossier contenant ce script)
...
echo "  python3 $PROJECT_DIR/pipeline/collector_redis.py"
echo ""
echo "Lancer le pipeline IA :"
echo "  python3 $PROJECT_DIR/pipeline/ml_pipeline.py"
echo "  python3 $PROJECT_DIR/pipeline/llm_analyzer_bgl.py"
echo ""
echo "Lancer l'agent LangGraph :"
echo "  python3 $PROJECT_DIR/agent/agent.py"
echo ""
echo "Vérifier Redis :"
echo "  docker exec -it redis redis-cli"
echo ""
echo "Extraire les features pour le ML :"
echo "  python3 $PROJECT_DIR/pipeline/extract_features.py --output data/dataset_bgl_replay.csv"
echo ""
